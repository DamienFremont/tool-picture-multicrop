...
public class ImageRecognitionUtilsTest {
	String resources = BatchTest.path + "\\src\\test\\resources\\usecase-cv";
	String target = BatchTest.path + "\\target\\test-classes\\usecase-cv-result";
